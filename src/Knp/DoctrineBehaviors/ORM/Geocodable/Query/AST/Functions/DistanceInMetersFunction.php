...
/**
 * DQL function for calculating distances in km between two points
 *
 *   DISTANCE_IN_METERS(entity.point, POINT(:param))
 */
class DistanceInMetersFunction extends FunctionNode
{
