...
class TranslatableListener extends AbstractListener
{
                                ...
                                $translatableTrait, $translationTrait, $translatableFetchMode, $translationFetchMode)
    {
        ...
        $this->translatableFetchMode = $this->convertFetchModeString($translatableFetchMode);
        $this->translationFetchMode = $this->convertFetchModeString($translationFetchMode);
    }
     ...
     * @return int
     */
    private function convertFetchModeString($fetchMode){
